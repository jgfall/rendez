...
import { Save, User, Building2, Upload, Camera, X, ChevronDown, ChevronUp, Plus, CreditCard } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      if (profile) {
        ...
        // Payment link
        setPaymentLinkUrl(profile.payment_link_url || '');
      }
        ...
        <Card variant="elevated" padding="lg">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-sand-500">Set your external payment link for client deposits</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="mt-2 text-xs text-sand-500">
                Add your Stripe Payment Link, PayPal.me, Wise, or other payment service URL. 
                Clients will use this to pay deposits.
              </p>
            </div>
          </div>
        </Card>
