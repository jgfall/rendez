-- Migration: Update get_public_proposal_by_slug to support hide_until_deposit blocks
-- This replaces the old visibility-based logic with the new hide_until_deposit system
